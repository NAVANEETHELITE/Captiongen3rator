...
- This model is trained on the Flicker8K dataset.
- <strong>Flickr8k Dataset:</strong> <a href="https://forms.illinois.edu/sec/1713398">Dataset Request Form</a>

<strong>UPDATE (April/2021):</strong> The official site seems to have been taken down (although the form still works). Here are some <b> direct download links</b>:
...
<p align="center">
  <img src="https://miro.medium.com/max/1250/1*rfYN2EELhLvp2Van3Jo-Yw.jpeg" width="85%" title="ARCHUTECTURE" alt="ARCHUTECTURE">
</p>

- The sample outputs of the model are given below :
<p align="center">
  <img width="50%" src="https://github.com/NAVANEETHELITE/Captiongen3rator/blob/main/examples/img1.png" alt="Example output">
  <img width="50%" src="https://github.com/NAVANEETHELITE/Captiongen3rator/blob/main/examples/img2.png" alt="Example output">
</p>
